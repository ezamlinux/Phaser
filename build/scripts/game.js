...
},{"./Bottle":45,"./Crate":49}],47:[function(require,module,exports){
'use strict';
...
},{"objects/Coin":47,"objects/Crate":49}],49:[function(require,module,exports){
'use strict';
...
var Katana = function (_Phaser$Sprite) {
    ...
    function Katana(game, x, y, _coins) {
        ...
        _this.body.onCollide = new Phaser.Signal();
        _this.body.onCollide.add(_this.onHit, _this);
        _this.game.GLOBAL.katana.add(_this);
        return _this;
    }
...
var Player = function (_Phaser$Sprite) {
    ...
    _createClass(Player, [{
        ...
        value: function getDamage(_x) {
            this.life -= _x;
            if (this.life == 0) {
                _Socket2.default.playerDead({ 'coins': this.coins, "score": this.score });
